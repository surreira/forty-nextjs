            ...
            <div className="row gtr-200">
              ...
              <div className="col-6 col-12-medium">
                ...
                <span className="image fit">
                  <img src="https://placeimg.com/640/480/forrest" alt="" />
                </span>
                <div className="box alt">
                  <div className="row gtr-50 gtr-uniform">
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/meadow" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/trees" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://loremflickr.com/640/480/fog" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img
                          src="https://loremflickr.com/640/480/mountain"
                          alt=""
                        />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/farm" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/jungle" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/desert" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/wild" alt="" />
                      </span>
                    </div>
                    <div className="col-4">
                      <span className="image fit">
                        <img src="https://placeimg.com/640/480/beach" alt="" />
                      </span>
                    </div>
                  </div>
                </div>
